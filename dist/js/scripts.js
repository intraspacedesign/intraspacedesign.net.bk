      ...
      this.$get = ['$injector', '$interpolate', '$exceptionHandler', '$templateRequest', '$parse', '$controller', '$rootScope', '$sce', '$animate', '$$sanitizeUri', function($injector, $interpolate, $exceptionHandler, $templateRequest, $parse, $controller, $rootScope, $sce, $animate, $$sanitizeUri) {
        ...
        function applyDirectivesToNode(directives, compileNode, templateAttrs, transcludeFn, jqCollection, originalReplaceDirective, preLinkFns, postLinkFns, previousCompileContext) {
          ...
          function getControllers(directiveName, $__require, $element, elementControllers) {
            ...
            } else if (isObject($__require)) {
              value = {};
              forEach($__require, function(controller, property) {
          ...
          function nodeLinkFn(childLinkFn, scope, linkNode, $rootElement, boundTranscludeFn) {
            ...
            forEach(controllerDirectives, function(controllerDirective, name) {
              var $__require = controllerDirective.require;
              if (controllerDirective.bindToController && !isArray($__require) && isObject($__require)) {
                extend(elementControllers[name].instance, getControllers(name, $__require, $element, elementControllers));
              }
            });
...
$__System.registerDynamic("1", ["2", "3"], true, function($__require, exports, module) {
  ...
  global.define = undefined;
  $__require('2');
  var image_1 = $__require('3');
  console.log(angular);
  angular.element(document).ready(function() {
    angular.bootstrap(document, [image_1.default], {strictDi: true});
  });
  Object.defineProperty(exports, "__esModule", {value: true});
